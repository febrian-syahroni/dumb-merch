...
export default function MessagePage() {
  return (
    <div className="flex flex-col justify-center bg-[#0B0B0B] text-white w-full h-full">

      {/* Complain */}
      <div className="flex h-full">
        {/* users */}
        <div className="flex overflow-y-auto hide-scrollbar h-[75%] flex-col gap-[30px] px-[50px] mt-[130px] w-1/3">
          <CardUser />
          <CardUser />
          <CardUser />
          <CardUser />
